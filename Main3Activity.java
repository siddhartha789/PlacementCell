...
public class Main3Activity extends AppCompatActivity {
    ...
    public void test(View v)
    {
        ...
        url=e3.getText().toString();
        myTask=new AsyncTask<Void, Void, Void>() {
            @Override
            protected Void doInBackground(Void... voids) {
                Contact(Main3Activity.this, id,title,url);
                return null;
            }
        };
    ...
    void Contact(Context c, String id, String title, String url)
    {
        String serverURL = "https://phycho.000webhostapp.com/test2data.php";
