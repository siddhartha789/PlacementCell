...
public class companylogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Company Login");
    ...
    public void login(View v)
    {
        ...
        if(st==true)
        {
            ...
            if(CheckConnection.isNetworkAvailable(companylogin.this))
            {
            ...
            {
                Toast.makeText(companylogin.this, "Please turn on your network connection to avail services.", Toast.LENGTH_SHORT).show();
    ...
    class AdminLoginTask extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL="https://phycho.000webhostapp.com/companylogin.php";
            InputStream is=null;
        ...
        protected void onPostExecute(String result) {
            ...
            if (s.equalsIgnoreCase("welcome")){
                Intent intent=new Intent(companylogin.this,companyaccount.class);
