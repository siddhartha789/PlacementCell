...
public class csstudentadapter extends BaseAdapter {

ArrayList<csstudent> ldata;
int rlayout;
Context c;

    public csstudentadapter(ArrayList<csstudent> ldata, int rlayout, Context c) {
        this.ldata = ldata;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        t1.setText(""+ldata.get(position).getRno());
        t2.setText(ldata.get(position).getFname());
        t3.setText(ldata.get(position).getContact());
