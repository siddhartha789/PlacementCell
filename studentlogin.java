...
public class studentlogin extends AppCompatActivity {
    ...
    public void login(View v)
    {
        ...
        if(st==true)
        {
            ...
            if(CheckConnection.isNetworkAvailable(studentlogin.this))
            {
            ...
            {
                Toast.makeText(studentlogin.this, "Please turn on your network connection to avail services.", Toast.LENGTH_SHORT).show();
    ...
    class AdminLoginTask extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL="https://phycho.000webhostapp.com/studentlogin.php";
            InputStream is=null;
